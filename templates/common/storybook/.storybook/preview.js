...
addDecorator((storyFn, context) => <ThemeProvider theme={theme}>{(storyFn(context))}</ThemeProvider>)
...
function loadStories() {
  req.keys().forEach((filename) => {
    ...
    const stories = storiesOf(`${configs.componentType}/${configs.componentName}`, module);
